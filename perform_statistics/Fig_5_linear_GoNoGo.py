...
#Rest
analysis_string = 'ASRS_linear_rest'
conditions = ['Rest_synth']
...
#Task
analysis_string = 'ASRS_linear_task'
conditions = ['spont']
dfa_core.jackknife_resampling(subject_list, frequencies, master_folder, morphing_op_path, graphfolder, conditions, stats_test, output_folder, analysis_string, pv_values)


'''GoNoGo Clinical ADHD (BIS)'''
subject_list = ['list of subjects']
...
#Rest
analysis_string = 'BIS_linear_rest'
conditions = ['Rest_synth']
dfa_core.jackknife_resampling(subject_list, frequencies, master_folder, morphing_op_path, graphfolder, conditions, stats_test, output_folder, analysis_string, pv_values)


#Task
analysis_string = 'BIS_linear_task'
conditions = ['spont']
dfa_core.jackknife_resampling(subject_list, frequencies, master_folder, morphing_op_path, graphfolder, conditions, stats_test, output_folder, analysis_string, pv_values)